export const CONTRACTS = {
  DIP_ADDRESS: process.env.NEXT_PUBLIC_DIP_ADDRESS as `${string}`,
  NFT_ADDRESS: process.env.NEXT_PUBLIC_NFT_ADDRESS as `${string}`,
  MARKET_ADDRESS: process.env.NEXT_PUBLIC_MARKET_ADDRESS as `${string}`,
};
